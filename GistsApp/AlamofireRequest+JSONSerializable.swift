...
//    public func responseObjectt<T: ResponseJSONObjectSerializabl>(completionHandler: Response<T, NSError> -> Void) -> Self {
...
//    }
    ...
    public func responseArrayy<T: ResponseJSONObjectSerializabl>(completionHandler: Response<[T], NSError> -> Void) -> Self {
        let serializer = ResponseSerializer<[T], NSError> { request, response, data, error in
